...
public final class ItemGenreBinding implements ViewBinding {
  ...
  private ItemGenreBinding(@NonNull TextView rootView, @NonNull TextView genreName) {
  ...
  public static ItemGenreBinding bind(@NonNull View rootView) {
    ...
    TextView genreName = (TextView) rootView;

    return new ItemGenreBinding((TextView) rootView, genreName);
  }
}
